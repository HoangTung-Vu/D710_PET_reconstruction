...
def header_fields(path):
    """Decode the 164-byte header the way `pet_recon` does."""
...
def test_npy_input_reads_the_shape_from_the_array(tmp_path, monkeypatch, capsys):
    mu = np.full((4, 8, 8), 0.0096, dtype=np.float32)
