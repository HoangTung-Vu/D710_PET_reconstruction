...
# CTAC first: it is what produces the 47 attenuation views the prep waits on.
run_context("CCTAC_3D", "$ctac", "0x43eef0", "0x441550", "0x441030", 6)
show("$cd->m_pAttn->m_pCyclicMemBuff->m_uiCounterElement")
